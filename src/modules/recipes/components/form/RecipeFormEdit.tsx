...
interface IRecipeFormEdit {
  recipeId: string;
}

const RecipeFormEdit = ({ recipeId }: IRecipeFormEdit): JSX.Element => {
  ...
  if (session && recipe && session.user._id !== recipe.author) {
    return (
